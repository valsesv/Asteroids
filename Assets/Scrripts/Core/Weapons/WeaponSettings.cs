namespace Asteroids.Core.Player
{
    ...
    public class LaserSettings
    {
        ...
        public float RechargeTime = 5f; // Time to recharge one charge
        public float Duration = 0.5f; // How long laser beam is active
        public float Width = 0.2f; // Laser beam width
    }
}
