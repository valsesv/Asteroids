...
public class BannerComponent : MonoBehaviour
{
    ...
    public AdEvent OnAdClicked;
    public AdEvent OnLeftApplication;
    public AdEvent OnReturnedToApplication;
    ...
    private void HandleAdClicked(object sender, EventArgs args) => OnAdClicked?.Invoke();
    private void HandleLeftApplication(object sender, EventArgs args) => OnLeftApplication?.Invoke();
    private void HandleReturnedToApplication(object sender, EventArgs args) => OnReturnedToApplication?.Invoke();
